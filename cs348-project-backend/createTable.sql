...
CREATE TABLE IF NOT EXISTS Tracks (
    ...
    speechiness DECIMAL(16,15) CHECK (FLOOR(danceability) = 0 AND CEIL(danceability) = 1),
    acousticness DECIMAL(16,15) CHECK (FLOOR(danceability) = 0 AND CEIL(danceability) = 1),
    instrumentalness DECIMAL(16,15) CHECK (FLOOR(danceability) = 0 AND CEIL(danceability) = 1),
    liveness DECIMAL(16,15) CHECK (FLOOR(danceability) = 0 AND CEIL(danceability) = 1),
    valence DECIMAL(16,15) CHECK (FLOOR(danceability) = 0 AND CEIL(danceability) = 1),
    tempo DECIMAL(7, 3),
    time_signature INT,
